...
const licenseLookup = (code) => {
  return code === 'public'  ?  'https://creativecommons.org/publicdomain/mark/1.0/'
      : code === 'CC0'          ? 'https://creativecommons.org/publicdomain/zero/1.0/'
          : code === 'CC_BY'        ? 'https://creativecommons.org/licenses/by/1.0'
              : code === 'CC_BY_SA'     ? 'https://creativecommons.org/licenses/by-sa/1.0'
                  : code === 'CC_BY_ND'     ? 'https://creativecommons.org/licenses/by-nc-nd/1.0'
                      : code === 'CC_BY_NC'     ? 'https://creativecommons.org/licenses/by-nc/1.0'
                          : code === 'CC_BY_NC_SA'  ? 'https://creativecommons.org/licenses/by-nc-sa/1.0'
                              : code === 'CC_BY_NC_ND'  ? 'https://creativecommons.org/licenses/by-nc-nd/1.0'
                                  : code === 'RS_INC_EDU'   ? 'http://rightsstatements.org/vocab/InC-EDU/1.0/'
                                      : code === 'RS_NOC_OKLR'  ? 'http://rightsstatements.org/vocab/NoC-OKLR/1.0/'
                                          : code === 'RS_INC'       ? 'http://rightsstatements.org/vocab/InC/1.0/'
                                              : code === 'RS_NOC_NC'    ? 'http://rightsstatements.org/vocab/NoC-NC/1.0/'
                                                  : code === 'RS_INC_OW_EU' ? 'http://rightsstatements.org/vocab/InC-OW-EU/1.0/'
                                                      : code === 'RS_CNE'       ? 'http://rightsstatements.org/vocab/CNE/1.0/' : ''
};
